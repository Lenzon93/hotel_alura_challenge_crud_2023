...
public class RegistroHuesped extends JFrame {
	...
	private void guardarHusepedes() {
		if (txtFechaN.getDate()!=null&&!txtNombre.equals("")&&!txtApellido.equals("")&&!txtTelefono.equals("")) {
			...
			int nReserva=Integer.parseInt(txtNreserva.getText().toString());
			...
			JOptionPane.showMessageDialog(this, "Favor rellena los campos");
		}
	}
